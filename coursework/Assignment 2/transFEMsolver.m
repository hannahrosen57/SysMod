...
% D, lambda, and F - diffusion coeff, linear reaction coeff, and source 
%                    term; each either scalar or a vector of length X.N,
% c0 - initial conditions, either scalar or a vector of length X.N+1,
% and BCs - a [1x4] vector containing dirchlet at xmin, dirichlet
